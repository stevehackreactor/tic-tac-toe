...
viewFunctions.renderO = (event) => {
  event.target.style.backgroundImage = "url('https://lh3.googleusercontent.com/proxy/91dnuPX2rayiTPvsWb6Ai-7V07lyMOzytMAEv8rvpJ4VsVSymWBMoH1HLHTRlqH2nWZ-ygT35Duish0xjJ6yzG7c5AxPx8FT6AGxNfL89nPGkp5mQBXyH17nhuxII6bBd40-baeHvF1tLPMAuEczPE88t4Aj7rAV_qUrAieA3yDsLdBcuw8')"; // image for O
}
...
viewFunctions.updateScores = () => {
  document.getElementById('score').innerHTML = `${state.oName} has ${state.oWins} wins<img src="https://lh3.googleusercontent.com/proxy/91dnuPX2rayiTPvsWb6Ai-7V07lyMOzytMAEv8rvpJ4VsVSymWBMoH1HLHTRlqH2nWZ-ygT35Duish0xjJ6yzG7c5AxPx8FT6AGxNfL89nPGkp5mQBXyH17nhuxII6bBd40-baeHvF1tLPMAuEczPE88t4Aj7rAV_qUrAieA3yDsLdBcuw8" width="100" height="100"><br><br><br><br><br><br>${state.xName} has ${state.xWins} wins<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNUOdtMq8p0P87h6rsG168Ecbph7jS_hneRg&usqp=CAU" width="100" height="100">`;
}
  ...
  for (let i = 0; i < state.boardState.length; i++) {
    for (let j = 0; j < state.boardState.length; j++) {
      if (state.boardState[i][j] === null) {
        ...
        document.getElementById(`square${squareLoc}`).style.backgroundImage = "url('https://lh3.googleusercontent.com/proxy/91dnuPX2rayiTPvsWb6Ai-7V07lyMOzytMAEv8rvpJ4VsVSymWBMoH1HLHTRlqH2nWZ-ygT35Duish0xjJ6yzG7c5AxPx8FT6AGxNfL89nPGkp5mQBXyH17nhuxII6bBd40-baeHvF1tLPMAuEczPE88t4Aj7rAV_qUrAieA3yDsLdBcuw8')";
      }
      squareLoc++;
    }
  }
